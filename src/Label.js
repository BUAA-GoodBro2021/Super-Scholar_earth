...
import { hl, fl, ml, gl, cl, Ml, ul, dl,pl } from './ConstantDefinition.js'
...
export default class Label {
    ...
    show() {
        if (1 == this.isVisible)
            return;
        const {domElement: t, controls: e} = this.props;
        t.classList.add("cursor-pointer"),
        this.element.classList.remove("d-none"),
        this.element.classList.add("d-block"),
        e.autoRotationSpeedScalarTarget = 0,
        this.isVisible = !0
    }
    hide() {
        if (0 == this.isVisible)
            return;
        const {domElement: t, controls: e} = this.props;
        t.classList.remove("cursor-pointer"),
        this.element.classList.remove("d-block"),
        this.element.classList.add("d-none"),
        e.autoRotationSpeedScalarTarget = 1,
        this.isVisible = !1
    }
    dispose() {
        this.element && this.element.parentNode && document.body.removeChild(this.element),
        this.element = null,
        this.props = null,
        this.icon = null,
    ...
    colorDotForLanguage(t) {
        ...
        return e.style.color = this.colorForLanguage(t),
        e.textContent = " • ",
        e
    }
    colorForLanguage(t) {
